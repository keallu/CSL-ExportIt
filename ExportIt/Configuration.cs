...
public abstract class Configuration<C> where C : class, new()
{
    ...
    public static C Load()
    {
        if (instance == null)
        {
            ...
            {
                Debug.Log("[Export It!] Configuration:Load -> Exception: " + e.Message);
            }
        }
    ...
    public static void Save()
    {
        ...
        {
            Debug.Log("[Export It!] Configuration:Save -> Exception: " + e.Message);
        }
    }
    ...
    private static string GetConfigPath()
    {
        ...
        {
            Debug.Log("[Export It!] Configuration:GetConfigPath -> ConfigurationPath attribute missing in " + typeof(C).Name);
